...
<template>
  <nav :class="[
    ...
    isScrolled ? 'bg-moss-950/90 backdrop-blur-md shadow-sm' : 'bg-transparent'
  ]">
      ...
      <Disclosure v-slot="{ open }">
        ...
        <DisclosurePanel class="md:hidden bg-moss-950/90 backdrop-blur-md">
          <div class="px-2 pt-2 pb-3 space-y-1">
            <a href="#about" class="block px-3 py-2 text-moss-300 hover:text-moss-200">About</a>
            <a href="#skills" class="block px-3 py-2 text-moss-300 hover:text-moss-200">Skills</a>
            <a href="#projects" class="block px-3 py-2 text-moss-300 hover:text-moss-200">Projects</a>
            <a href="#experience" class="block px-3 py-2 text-moss-300 hover:text-moss-200">Experience</a>
            <a href="#contact" class="block px-3 py-2 text-moss-300 hover:text-moss-200">Contact</a>
          </div>
        </DisclosurePanel>
      </Disclosure>
    </div>
