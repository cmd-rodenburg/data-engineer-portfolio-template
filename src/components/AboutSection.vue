    ...
    <div class="container mx-auto px-4 py-12">
      <div class="md:grid md:grid-cols-[2fr_1fr] md:gap-12">
        <div>
          ...
          <p class="text-xl text-emerald-500 font-semibold mb-8">Freelance data engineer with a knack for business intelligence</p>
          <div class="space-y-6 order-last md:order-none">
            <p class="text-justify text-gray-300 leading-relaxed">
              With a master’s degree in Molecular Medicine, I apply strong analytical skills 
              in the Data Engineering field. I love tackling issues at the core, 
              finding efficient solutions to complex problems.
            </p>
            <p class="text-justify text-gray-300 leading-relaxed">
              Working for large companies such as Accenture, Cargill, Transavia, and Capgemini 
              I gained valuable expereince in both Dutch and German markets
